...
export const trashListProducts =
  ...
  async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(
        `${baseURL.api}/products/trash?page=${pageNumber}`
      )
      dispatch({
...
export const restoreProduct = (id) => async (dispatch, getState) => {
  try {
    ...
    await axios.patch(`${baseURL.api}/products/${id}/restore`, config)
...
export const forceProduct = (id) => async (dispatch, getState) => {
  try {
    ...
    await axios.patch(`${baseURL.api}/products/${id}/force`, config)
  ...
  (reviewId, productId) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.delete(
        `${baseURL.api}/products/${productId}/reviews?reviewId=${reviewId}`,
        config
      )
      dispatch({
...
export const countProducts = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${baseURL.api}/products/count`, config)
    dispatch({
